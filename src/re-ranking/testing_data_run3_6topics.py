...
path_ab = "results/run3-6topics/abstracts_clean/topic"
path_pr = "results/run3-6topics/proceedings_clean/topic"
...
topics_collection = [17, 18, 19, 20, 21, 24]
for top in topics_collection:
    ...
    json.dump(retri, open("results/run3-6topics/topic%d.json"%(top+1), "w"))