...
path_ab = "results/run5-expansion-weight-treatment-unsupervise/abstracts_clean/topic"
path_pr = "results/run5-expansion-weight-treatment-unsupervise/proceedings_clean/topic"
query_label = ['query']
...
for top in range(50):
    ...
    json.dump(retri, open("results/run5-expansion-weight-treatment-unsupervise/topic%d.json"%(top+1), "w"))