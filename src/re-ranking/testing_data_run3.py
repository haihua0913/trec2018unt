...
path_ab = "results/run3-expansion-weight/abstracts_clean/topic"
path_pr = "results/run3-expansion-weight/proceedings_clean/topic"
...
for top in range(9,10):
    ...
    json.dump(retri, open("results/run3-expansion-weight/topic%d.json"%(top+1), "w"))